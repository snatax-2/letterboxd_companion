...
- **`tests/e2e/tv-shows-noter-flow.spec.js`** — nouveau flux dans Noter (remplace l'ancienne grille de la Phase 2, retirée) : saison jamais touchée montre un menu "Commencer" qui ajoute le premier épisode au widget En cours, saison déjà en cours pointe vers ce widget sans dupliquer le suivi, saison terminée (par épisodes ou déjà notée) ouvre directement le formulaire de notation préempli.
