...
- **`tests/e2e/tv-shows-phase2.spec.js`** — module Séries, Phase 2 (suivi épisode par épisode) : cocher/décocher, barre de progression, proposition de rattrapage acceptée et refusée, bandeau de fin de saison qui apparaît/disparaît correctement, persistance en stockage local, zéro violation d'accessibilité.
